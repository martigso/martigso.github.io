...
**Røed, Maiken and Martin Søyland (2025)**. _Trade Union Appeals in the UK House of Commons (1950-2019)_. 
...
**Søyland, M., Djuve, V. L., and Tørstad, V. (2025)**. _From Ideas to Global Goals: Sustainable Development Goals in the United Nations General Assembly._

::: {.callout-tip collapse="true"}
## Abstract:

The global Sustainable Development Goals (SGDs) have affected international and national politics greatly over the last decade. Although the formalization of the goals are quite new, the ideas behind them have been developed over large stretches of time. In this paper, I leverage the SGD corpus to map SGD attention in United Nations General Assembly's (UNGA) annual debates since the UN's initiation in the aftermath of World War II. More specifically, I fine-tune a large language model to identify SGD prevalence in text and estimate UNGA member state's varying emphasis on the SDGs over time. I further show how influential member states are able to steer the attention towards specific SGDs. The paper contributes to our descriptive understanding of spatial and longitudinal prevalence of SGDs in the UNGA and how the interaction between states in the UN General Debates are shaped by influential member states.
:::
